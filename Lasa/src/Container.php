		...
		if (class_exists($name)) {
			...
			if (is_null($constructor)) {
				...
				foreach ($constructor->getParameters() as $param) { /* @var $param \ReflectionParameter */
					$reflectionClassName = $param->getType() . "";

					if (isset($params[$param->getName()])) {
						$instanceParams[] = $params[$param->getName()];
					} else if ($reflectionClassName && isset($params[$reflectionClassName])) {
						$instanceParams[] = $params[$reflectionClassName];
					} else if ($reflectionClassName) {
						$instanceParams[] = $this->make($reflectionClassName);
