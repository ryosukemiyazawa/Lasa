...
class ListedLabelTest extends \PHPUnit\Framework\TestCase {
	use ViewTestBase;
	...
	function testOutput() {
		...
		$this->assertStringContainsString($target_string1, $content);
		$this->assertStringContainsString($target_string2, $content);
