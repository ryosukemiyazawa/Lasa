...
class SimpleCrudTest extends \PHPUnit\Framework\TestCase {
	...
	function 挿入テスト() {
		...
		foreach ($result as $obj) {
			$this->assertStringContainsString("obj", $obj->getTitle());
			$this->assertStringContainsString("content", $obj->getContent());
		}
